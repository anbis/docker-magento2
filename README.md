...
Magento2 Helper
---------------
На правах реклами хочу запропонувати вам також використовувати додатковий інструмент для пришвидшення взаємодії з контейнерамии та `bin/magento` - [magento2-helper](https://github.pp.ua/anbis/magento2-helper)
